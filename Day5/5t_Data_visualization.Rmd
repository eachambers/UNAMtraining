...
For `ggtree()`, we're going to use the Nexus file that you created from the Day 4 RAxML worksheet. To recap, this Nexus file should contain the Rana ddRAD tree *with support values and branch lengths*. Move (or copy) that file to the current working directory. The file should be called `ranaddrad_tree.nexus`.
